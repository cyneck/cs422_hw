...
print(paste("Grid search resulted in the best model at ntree =",result[1],
              " and mtry =", result[2]),digits = 3)
print(paste("Accuracy =",result[4]),digits = 3)
print(paste("Balanced Accuracy = ",result[5]),digits = 3)
print(paste("Sensitivity =",result[7]),digits = 3)
print(paste("Specificity =",result[6]),digits = 3)
```
