...
Answer:
      The overall accuracy of the model: 0.810
...
for (batch_size in batch_size_range){
  ...
  print(paste("Time taken to train neural network:",end-begin,"(seconds)"))
  print(paste("Overall accuarcy:",metrics$Accuracy))
  print("\n")
