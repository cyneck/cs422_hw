...
Answer:
      The overall accuracy of the model: 0.825
...
create_model2 <- function (){
  ...
  layer_dense(model2,units = 256, activation = 'relu')  # hidden layer
  layer_dense(model2,units = 512, activation = 'relu')  # hidden layer
...
the training mini-batch of the (d) model is 128, and the training time of the (b) model is faster.